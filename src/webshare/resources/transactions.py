"""The transaction resource (`client.transactions`)."""
...
from webshare.types.commerce import Transaction
...
def _get_spec(id: int) -> RequestSpec:
    return RequestSpec(method="GET", path=f"/api/v2/payment/transaction/{id}/")
