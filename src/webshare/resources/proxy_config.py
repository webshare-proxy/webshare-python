        ...
        json_body=drop_json_nulls(
            {
                ...
                "ip_authorization_state": ip_authorization_state,
                "ip_authorization_postalcode": ip_authorization_postalcode,
...
class ProxyConfigResource(SyncResource):
    ...
    def update(
        ...
        *,
        ...
        ip_authorization_state: str | None = None,
        ip_authorization_postalcode: str | None = None,
